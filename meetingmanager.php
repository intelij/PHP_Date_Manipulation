...
/**
 * 
 * Below is the problem defination which this file is trying to address.
 * 
 * The Client development team are required to have a mid month meeting in order to discuss the ongoing improvements 
 * and new features to the code base. This meeting is planned for the 14th of every month. Testing is also done on a 
 * monthly basis and should be done on the last day of the month.
 ...
 * With this in mind, design a command line script that will write a CSV to file 
 * outputting the columns 'Month', 'Mid Month Meeting Date' and 'End of Month Testing Date' for the next six months.
 *
